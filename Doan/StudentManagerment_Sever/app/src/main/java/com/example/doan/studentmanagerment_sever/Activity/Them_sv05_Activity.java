...
public class Them_sv05_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_them_sv05_);
...
//Initializing views
    ...
    // ADD SV
    private void addSV05(String url)
    {
        GlobalVar.qlsvApiHolder.addEmp1(new Emp2(0,editTextName.getText().toString().trim(),editTextMasv.getText().toString().trim(),editTextLink.getText().toString().trim(),Double.parseDouble(editTextDTB.getText().toString().trim()))).enqueue(new Callback<String>() {
            @Override
